...
const QuestCard: React.FC<{
  ...
  return (
    <Card className="border shadow-sm transition-all hover:border-blue-200 hover:shadow-md dark:hover:border-blue-800">
      <div className="space-y-3 p-4">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-1.5 rounded-lg border border-blue-200 bg-blue-50 px-2.5 py-1 dark:border-blue-800 dark:bg-blue-900/10">
            <span className="font-numeric text-sm font-bold text-blue-600 dark:text-blue-400">
              {quest.xpValue}
            </span>
