...
const TodaysQuests = () => {
    ...
    return (
        <section className="py-16 px-6 bg-gradient-to-b from-slate-900 to-slate-950 rounded-3xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {quests.map((quest) => (
                    <div
                        key={quest.title}
                        className={`group p-6 rounded-2xl border border-purple-700 transition-all duration-500 ${quest.completed ? "bg-green-800 hover:shadow-2xl" : "bg-purple-800 hover:shadow-2xl"
                            }`}
                    >
