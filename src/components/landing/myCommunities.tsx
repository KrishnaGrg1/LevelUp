...
const MyCommunities = () => {
    ...
    return (
        <section className="relative py-16 bg-gradient-to-b from-slate-900 to-slate-950 px-6 rounded-3xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {communities.map((community) => {
                    const xpPercent =
                        (parseInt(community.xp.split("/")[0]) /
                            parseInt(community.xp.split("/")[1])) *
                        100;
                    return (
                        <div
                            key={community.name}
