        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${language}/features`} className="text-slate-400 hover:text-white transition-colors text-sm">
                  {t('footer.product.features')}
                </Link>
              </li>
              <li>
                <Link href={`/${language}/pricing`} className="text-slate-400 hover:text-white transition-colors text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${language}/about`} className="text-slate-400 hover:text-white transition-colors text-sm">
                  {t('footer.company.about')}
                </Link>
              </li>
              <li>
                <Link href={`/${language}/contact`} className="text-slate-400 hover:text-white transition-colors text-sm">
