        ...
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            ...
            const timer = setInterval(() => {
              ...
              currentCountries += Math.ceil(targetCountries / (duration / increment));
              currentMilestones += Math.ceil(targetMilestones / (duration / increment));
            ...
            {[
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-slate-300 text-lg font-medium mb-2">{t(stat.label)}</p>
            ...
            {[
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-slate-400 leading-relaxed">{t(mission.description)}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              <div key={index} className="flex items-start space-x-6 group">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-4">{t(value.title)}</h3>
                  <p className="text-slate-400 leading-relaxed">{t(value.description)}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            {[
              ...
              >
                <div className="relative">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">{t(member.name)}</h3>
                  <p className="text-purple-400 font-medium mb-4">{t(member.role)}</p>
                  <p className="text-slate-400 text-sm leading-relaxed">{t(member.bio)}</p>
                </div>
              </div>
            ))}
          </div>
